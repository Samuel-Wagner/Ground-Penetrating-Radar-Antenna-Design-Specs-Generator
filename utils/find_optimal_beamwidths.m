...
%
% this function will take a horizontal resolution vs. beamwidth plot
% and find the "optimal" beamwidths based on horizontal resolution
% by looking at min HR + 10% min HR and finding the left and right edges
% after which HR > min_HR*1.1
%
% inputs - HPBWs: half power beamwidths of each antenna pattern
%          HRS  : horizontal resolutions corresponding to the HPBWs
%
% outputs 
% hpbw_min, hpbw_max - the left and right edges of the optimal "band" for imaging
...
% re-shift the right index
right_ind = (numel(right)-right_ind) + min_ind;

% minimum and maximum HPBWs
